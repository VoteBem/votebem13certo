...
<html lang="pt-br">
	<head>
		<title>Vote Bem - Menu de Partidos</title>
					...
					<div class="col s12 m4">
						<div class="card">
							...
							<div class="card-action center">
								<a href="form_partidos.php" class="blue-text">Adicionar Novo Partido</a>
							</div>
						</div>
					</div>
					<div class="col s12 m4">
						<div class="card">
							...
							<div class="card-action center">
								<a href="editar_partidos.php" class="blue-text">Editar Partido</a>
							</div>
						</div>
					</div>
					<div class="col s12 m4">
						<div class="card">
							...
							<div class="card-action center">
								<a href="excluir_partidos.php" class="blue-text">Excluir Partido</a>
							</div>
						</div>
					</div>
				</div>
