...
<html lang="pt-br">
	<head>
		<title>Vote Bem - Menu de Candidatos</title>
					...
					<div class="col s12 m4">
						<div class="card">
							...
							<div class="card-action center">
								<a href="form_candidatos.php" class="blue-text">Adicionar Novo Candidato</a>
							</div>
						</div>
					</div>
					<div class="col s12 m4">
						<div class="card">
							...
							<div class="card-action center">
								<a href="editar_candidatos.php" class="blue-text">Editar Candidato</a>
							</div>
						</div>
					</div>
					<div class="col s12 m4">
						<div class="card">
							...
							<div class="card-action center">
								<a href="excluir_candidatos.php" class="blue-text">Excluir Candidato</a>
							</div>
						</div>
					</div>
				</div>
